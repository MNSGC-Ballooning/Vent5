...
//NOTES:
//Check over pressure sensor backup; Does setting altFeet = pressureAltFeet mess up GPS code if GPS_LOCK isn't a check?
//Potentially remove stateReturn / suggestedState
//Fix camel-case on variables (Last priority)
//CHANGE BACK BARO/PRESSURE SENSORS (For testing without pressure sensors)
//CHANGE FLIGHT BOUNDARIES BEFORE ANY FLIGHT
//CHANGE IF BACK TO WHILE FOR AIRBORNE MODE (SystemSetup; Only for current GPS emulation testing)
...
// SD Card
  ...
  String header = "Time (s),Battery Temperature (F),Pressure (psi),Pressure Altitude (feet),Lat,Long,Altitude (feet),# of Satellites, Rate (m/s),Heater State,Vent State,Measured Servo Position (degrees),Cutter State,Suggested State,State,Vent Reason";
  File datalog; 
  File datalogIMU;
...
///////////////////////**********Timer and misc. variables********///////////////////////////
  ...
  bool FlightHasBegun=false; // this is triggered once the balloon/vent crossed 5000 feet altitude to prevent the balloon from prematurely cutting/terminating/venting below 5000 feet; no logic executed before it crosses 5000 feet.
  ...
  float latitude, lon, altFeet; // GPS variables
...
//CHANGE BEFORE FLIGHT CHANGE BEFORE FLIGHT CHANGE BEFORE FLIGHT CHANGE BEFORE FLIGHT CHANGE BEFORE FLIGHT CHANGE BEFORE FLIGHT CHANGE BEFORE FLIGHT CHANGE BEFORE FLIGHT 
//CHANGE BEFORE FLIGHT CHANGE BEFORE FLIGHT CHANGE BEFORE FLIGHT CHANGE BEFORE FLIGHT CHANGE BEFORE FLIGHT CHANGE BEFORE FLIGHT CHANGE BEFORE FLIGHT CHANGE BEFORE FLIGHT 
  #define EASTERN_BOUNDARY -91.89 //East of Durand/in-line w Menomonie
  #define WESTERN_BOUNDARY -93.51 //Waseca
  #define SOUTHERN_BOUNDARY 43.60 //Rose creek
  #define NORTHERN_BOUNDARY 44.66 //Ono
//CHANGE BEFORE FLIGHT CHANGE BEFORE FLIGHT CHANGE BEFORE FLIGHT CHANGE BEFORE FLIGHT CHANGE BEFORE FLIGHT CHANGE BEFORE FLIGHT CHANGE BEFORE FLIGHT CHANGE BEFORE FLIGHT 
//CHANGE BEFORE FLIGHT CHANGE BEFORE FLIGHT CHANGE BEFORE FLIGHT CHANGE BEFORE FLIGHT CHANGE BEFORE FLIGHT CHANGE BEFORE FLIGHT CHANGE BEFORE FLIGHT CHANGE BEFORE FLIGHT 
//CHANGE BEFORE FLIGHT CHANGE BEFORE FLIGHT CHANGE BEFORE FLIGHT CHANGE BEFORE FLIGHT CHANGE BEFORE FLIGHT CHANGE BEFORE FLIGHT CHANGE BEFORE FLIGHT CHANGE BEFORE FLIGHT 
